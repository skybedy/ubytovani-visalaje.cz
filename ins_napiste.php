...
//	elseif (strstr($email,'@')=='') echo "<b>Email</b> byl nesprávně vyplněn. <font color=#FF0000>Vraťte se tlačítkem zpět ve vašem prohlížeči a vyplňte jej.</font><p>";
	...
	else 
	{
		...
		$predmet="UBYTOVANI: Napiste nam";
//		$zprava="Bylo zadano do formulare\n";
		$zprava=$vlozeny_text;
		$zprava.="\n\n";
		$zprava.=$nick." ".$email." ".$telefon;
		$header="From: $email\n";
...
<form action="" method="post">
	...
	<tr>
		<td colspan="2">
			<b>Váš dotaz:</b><br>
			<textarea cols="83" rows="10" name="vlozeny_text"></textarea>
		</td>
	</tr>
	<tr>
